...
function List() {
    ...
    return (
        <ListContext.Provider value={{
            listCount, setListCount, compare,
            currentCard, setCurrentCard, dragStatus, setDragStatus
        }}>
            <main className={s.main}>
                <div className={s.mainInfo}>
                    <div className={s.info}>Create an anime list!
                        The list of anime allows you to consider and classify anime. All that you watched can be noted in your sheet.
                    </div>
                    <section className={s.infoPhone}>
                        If you are using a mobile device, then flip it for easy use.
                        <img draggable={false} src="/img/List/rotate.svg" alt="rotate" />
                    </section>
                </div>
